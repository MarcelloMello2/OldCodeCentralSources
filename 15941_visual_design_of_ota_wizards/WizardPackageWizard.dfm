object PackageWizardRepository: TPackageWizardRepository
  ...
  object ModuleCreatorForm: TModuleCreator
    ...
    SourceImpl.Strings = (
      ...
      'type'
        ...
        '  %%WizardClassName%% = class(TInterfacedObject, IOTANotifier, I' +
        'OTAWizard, IOTARepositoryWizard, IOTAFormWizard)'
      '  protected'
      '    { IOTANotifier }'
      '    procedure AfterSave;'
      '    procedure BeforeSave;'
      ...
      ''
        ...
        '--------------------------------------------------------'
      ''
      'function %%WizardClassName%%.GetGlyph: HICON;'
      ''
      'begin'
      '  Result := 0;'
      'end;'
  ...
  object ModuleCreatorProject: TModuleCreator
    ...
    SourceImpl.Strings = (
      ...
      'type'
        ...
        '  %%WizardClassName%% = class(TInterfacedObject, IOTANotifier, I' +
        'OTAWizard, IOTARepositoryWizard, IOTAProjectWizard)'
      '  protected'
      '    { IOTANotifier }'
      '    procedure AfterSave;'
      '    procedure BeforeSave;'
  ...
  object ModuleCreatorDMAddIn: TModuleCreator
    ...
    SourceImpl.Strings = (
      ...
      ''
      'begin'
      '  RegisterPackageWizard(T%1:s.Create(nil));'
      'end;'
      ''
