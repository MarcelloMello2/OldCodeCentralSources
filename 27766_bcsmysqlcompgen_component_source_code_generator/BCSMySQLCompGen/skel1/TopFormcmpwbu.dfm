object TopFormCmpC: TTopFormCmpC
  Left = 0
  Top = 0
  ...
  object JvStatusBar1: TJvStatusBar
    ...
    object date_n_time_lbl: TLabel
      Left = 333
      Top = 0
      Width = 82
      Height = 19
      Align = alRight
      Caption = 'date_n_time_lbl'
      ExplicitHeight = 15
    end
  end
  ...
  object TopFormdp1: TTopFormdp
    Left = 16
    Top = 8
  end
  object ADOTable1: TADOTable
    ConnectionString = 'Provider=MSDASQL.1;Persist Security Info=False;Data Source=eagle'
    TableName = 'eag01'
    Left = 280
    Top = 8
  end
