...
{%ToDo 'pgXmlDocApp.todo'}
{%ToDo 'pgXmlDocViewer30App.todo'}
...
{%File 'ModelSupport\uWinFormXmlDocApp\uWinFormXmlDocApp.txvpck'}
...
uses
  ...
  uWinFormXmlXsls in 'uWinFormXmlXsls.pas' {uWinFormXmlXsls.TWinFormXmlXsls: System.Windows.Forms.Form},
...
[STAThread]
begin
  Application.Run(uWinFormXmlXsls.TWinFormXmlXsls.Create);
end.
