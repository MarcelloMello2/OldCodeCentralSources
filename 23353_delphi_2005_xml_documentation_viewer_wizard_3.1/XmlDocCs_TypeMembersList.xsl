...
<xsl:template match="name">
	...
	<DL>
		<DT>
			<A>
			   <!--	<xsl:attribute name="href">GiveTypeMemberHelp.aspx?Member=<xsl:value-of select="substring-after(@name,':')" />
				</xsl:attribute> -->
				<B>
...
<xsl:template match="member" mode="events">
	...
	<DL>
		<DT>
			<A>
				<xsl:attribute name="href">GiveTypeMemberHelp.aspx?Member=<xsl:value-of select="substring-after(@name,':')" /></xsl:attribute>
				<B>
					<xsl:value-of select="substring-after(@name,concat($WhichType,'.'))" />
				</B>
			</A>
...
<!--	<xsl:template match="see">
	<A>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:attribute name="href">
				GiveTypeMemberHelp.aspx?Member=
