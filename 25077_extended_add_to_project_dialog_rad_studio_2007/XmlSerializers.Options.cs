...
namespace XmlSerializers.Options {
    ...
    public class XmlSerializationWriterTOptions : System.Xml.Serialization.XmlSerializationWriter {
        ...
        void Write4_TOptions(string n, string ns, global::Options.TOptions o, bool isNullable, bool needType) {
            ...
            WriteElementString(@"OpenFilesShortcut", @"", Write3_Keys(((global::System.Windows.Forms.Keys)o.@OpenFilesShortcut)));
            WriteEndElement(o);
        }
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
                    if (!paramsRead[0] && ((object) Reader.LocalName == (object)id3_OpenFilesShortcut && (object) Reader.NamespaceURI == (object)id2_Item)) {
                        {
                            o.@OpenFilesShortcut = Read3_Keys(Reader.ReadElementString());
                        }
                        paramsRead[0] = true;
                    }
                    else {
                        UnknownNode((object)o, @":OpenFilesShortcut");
                    }
                }
                else {
                    UnknownNode((object)o, @":OpenFilesShortcut");
