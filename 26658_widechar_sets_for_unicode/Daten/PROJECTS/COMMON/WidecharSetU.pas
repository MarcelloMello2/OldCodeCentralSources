...
<para>Last modified       2009-02-11</para>
</history>
<remarks>
...
are not. A IWidecharSet interface can be shared between different sets
...
type
  ...
  {! <summary>This is the public interface of a widechar set. The methods
   of this interface are not thread-safe in the current implementation.</summary>}
  IWidecharSet =  interface(IInterface)
  ['{43B22A11-7526-419E-9D3C-041B5B1BA929}']
    {! <summary>IWidecharSet.Cardinality returns the number of elements in the
       set.
       </summary>
       <returns>  the number of elements in the set.</returns> }
    function Cardinality: Integer;
    {! <summary>IWidecharSet.Clear sets the set to empty.</summary>
      <exception cref="EWidecharSetError">
      If the set is immutable the method will raise an EWidecharSetError
      exception.</exception> }
    procedure Clear;
    {! <summary>
      Returns a deep copy of the current set. Cloning an immutable set
      yields a copy that is not immutable.</summary>}
    function Clone: IWidecharset;
    {! <summary>IWidecharSet.CompareWith determines the relation of the
       passed set with this set.
       </summary>
       <returns> the set relation.  </returns>
       <param name="aSet">is the set to compare to the reference. This
       parameter cannot be nil.</param>
       <exception cref="EWidecharSetParameterError">
       Is raised if nil is passed for the parameter.</exception>
       <remarks>Two sets can be equal (contain the same elements), one
    ...
    {! <summary>
      Tests if the passed character is in the set. </summary>
       <returns> true if the character is in the set, false if not. </returns> }
    function Contains(C: Widechar): Boolean;
    {! <summary>
      Removes the passed character from the set. If the character is not
      in the set nothing will be done, this is not an error. </summary>
      <exception cref="EWidecharSetError">
      If the set is immutable the method will raise an EWidecharSetError
      exception.</exception> }
    procedure Exclude(C: Widechar);
    {! <summary>IWidecharSet.ExclusiveOr performs a set xor operation.
       </summary>
       <param name="aSet">is the set to combine with. This parameter cannot be
       nil.</param>
       <exception cref="EWidecharSetParameterError">Is raised if nil is passed
       as parameter.</exception>
       <exception cref="EWidecharSetError">
        If the set is immutable the method will raise an EWidecharSetError
        exception.</exception>
       <remarks>After the operation the set will contain all characters in
       ...
       subtracting the intersection of both sets from their union.
       </remarks> }
    procedure ExclusiveOr(aSet: IWidecharSet);
    {! <summary>
      Includes the (ANSI) characters in the passed set into the set. </summary>
      <exception cref="EWidecharSetError">
      If the set is immutable the method will raise an EWidecharSetError
      exception.</exception>
      <param name="aCharset">contains the 1-byte characters to include.</param>
      <param name="aEncoding">is an optional encoding that identifies
       the codepage the characters in aCharset belong to. If this parameter
       is nil the current system codepage is assumed.</param>
      <remarks>If aCharset contains characters in the range #128..#255
    ...
    {! <summary>
      Includes the passed character into the set. The character can
      already be in the set, this is not an error. </summary>
      <exception cref="EWidecharSetError">
      If the set is immutable the method will raise an EWidecharSetError
      exception.</exception> }
    procedure Include(C: Widechar); overload;
    {! <summary>IWidecharSet.IncludeAll sets all bits in the set. Note that
    ...
    {! <summary>IWidecharSet.IntersectWith performs an AND operation. As a
       result the set will contain all characters from the original set that
       are also present in the passed set.
       </summary>
       <param name="aSet">is the set to intersect with. This parameter cannot
       be nil.</param>
       <exception cref="EWidecharSetParameterError">Is raised if nil is passed
       as parameter.</exception>
       <exception cref="EWidecharSetError">
    ...
    {! <summary>IWidecharSet.Invert performs a unary NOT on the set. As a
       result the set will now contain all characters it did not contain
       before and none of those it did contain before.
       </summary>
      <exception cref="EWidecharSetError">
      If the set is immutable the method will raise an EWidecharSetError
      exception.</exception> }
    procedure Invert;
    {! <summary>IWidecharSet.IsEmpty test if the set is empty.
       </summary>
       <returns> true if the set is empty, false otherwise</returns> }
    function IsEmpty: Boolean;
    {! <summary>IWidecharSet.IsEqualTo checks if the passed set contains the
       same elements as this one.
       </summary>
       <returns> true if both sets are in fact the same set or both contain
       the same elements, false otherwise.
       </returns>
       <param name="aSet"> is the set to compare this one to. This parameter
       cannot be nil. </param>
       <exception cref="EWidecharSetParameterError">Is raised if nil is passed
       as parameter.</exception> }
    function IsEqualTo(aSet: IWidecharSet): Boolean;
    {! <summary>IWidecharSet.IsImmutable checks if the set is immutable.
       </summary>
       <returns> true if the set cannot be modified, false otherwise.
       </returns> }
    function IsImmutable: Boolean;
    {! <summary>IWidecharSet.Matches checks whether all characters in the
       passed string are contained in the set or not. </summary>
       <returns> true if all characters in S are in the set, false if not. An
       empty string always matches a set.
       </returns> }
    function Matches(const S: string): Boolean;
    {! <summary>IWidecharSet.MergeWith performs a set union operation.
       </summary>
       <param name="aSet">is the set to merge with. This parameter cannot be
       nil.</param>
       <exception cref="EWidecharSetParameterError">Is raised if nil is passed
       as parameter.</exception>
       <exception cref="EWidecharSetError">
        ...
        exception.</exception>
       <remarks>After the operation the set will contain all characters in
       aSet in addition to those originally present.
       </remarks> }
    procedure MergeWith(aSet: IWidecharSet);
    {! <summary>IWidecharSet.Subtract excludes all characters in the passed
       set from this set.</summary>
       <param name="aSet">contains the characters to remove. This parameter
       cannot be nil</param>
       <exception cref="EWidecharSetParameterError">Is raised if nil is passed
       as parameter.</exception>
      <exception cref="EWidecharSetError">
  ...
  {! <summary>This is the public interface of the widechar set factory.</summary>
  <remarks>The factory offers methods to create a widechar set either
  ...
  ['{6536A3BC-51A1-4B2B-AC08-3C66270A4A64}']
    {! <summary>IWidecharSets.Compare determines the relation between two sets.
       </summary>
       <returns> the set relation.  </returns>
       <param name="Set1"> is the reference set. This parameter cannot be nil.
       </param>
       <param name="Set2">is the set to compare to the reference. This
       parameter cannot be nil.</param>
       <exception cref="EWidecharSetParameterError">
    ...
    {! <summary>IWidecharSets.Create returns an empty set. </summary> }
    function Create: IWidecharset; overload;

    {! <summary>Returns a set containing the characters
       found in the passed string. The set can be modified.
       </summary>
       <param name="S"> contains the characters to incude in the set. A
       character can appear more than once and the string can also be empty.
       This would create an empty set.</param> }
    function Create(const S: string): IWidecharset; overload;

    {! <summary>IWidecharSets.Create returns a deep copy of the passed set.
       </summary>
       <param name="aSet">is the set to copy. If nil is passed an empty set
       will be returned.</param> }
    function Create(aSet: IWidecharSet): IWidecharset; overload;

    {! <summary>IWidecharSets.Create returns a set based on a set of Ansichar.
       </summary>
       <param name="aCharset">contains the characters to include in the set.
       These are ANSI characters. Those in the range #0 to #127 will be copied
       ...
       <param name="aEncoding">specifies which codepage the characters in the
       passed set belong to. If this parameter is nil the default (current
       system) codepage is assumed. </param> }
    function Create(const aCharset: TSyscharset; aEncoding: TEncoding =
        nil): IWidecharset; overload;

    {! <summary>IWidecharSets.Digits returns an immutable set containing
      the digits 0..9. </summary> }
    function Digits: IWidecharset;

    {! <summary>IWidecharSets.EditCommands returns an immutable set containing
    ...
    {! <summary>IWidecharSets.ExclusiveOr returns a new set that is the
       combination of the two passed sets by an exclusive or operation. </summary>
       <remarks>If either of the source sets is nil a copy of the second
    ...
    {! <summary>IWidecharSets.FloatChars returns an immutable set containing
      the digits 0..9, the + and - sign, and the current locales decimal
      separator. </summary> }
    function FloatChars: IWidecharSet;

    {! <summary>IWidecharSets.HexNumerals returns an immutable set containing
       the characters 0 to 9, a to f, and A to F.  </summary> }
    function HexNumerals: IWidecharSet;

    {! <summary>IWidecharSets.IdentifierChars returns an immutable set
       containing the characters usually accepted in identifiers by most classic
       programming languages. These are the letters a to z, A to Z, 0 to
       9 and the underbar _.  </summary> }
    function IdentifierChars: IWidecharSet;

    {! <summary>IWidecharSets.Intersect returns a new set that is the
       intersection of the two passed sets. </summary>
       <remarks>If either of the source sets is nil an empty set is returned.
       The result set contains all characters present in both source sets.
       </remarks> }
    function Intersect(Set1, Set2: IWidecharset): IWidecharset;

    {! <summary>IWidecharSets.Invert returns a copy of the source set that has
       all bits flipped.  </summary>
       <returns> a set that contains all characters not included in the source
       set.  </returns>
       <param name="aSet">is the set to invert. This parameter cannot be nil.
       </param>
       <exception cref="EWidecharSetParameterError">This exception is raised if the
       parameter is nil.</exception> }
    function Invert(aSet: IWidecharSet): IWidecharset;

    {! <summary>IWidecharSets.Latin1Letters returns an immutable set containing
      the Unicode equivalents of all letters from the Latin1 ANSI codepage. </summary> }
    function Latin1Letters:IWidecharSet;

    {! <summary>IWidecharSets.Latin1AlphaNum returns an immutable set containing
    ...
    {! <summary>IWidecharSets.Latin1Lowercase returns an immutable set containing
      the Unicode equivalents of all lower case letters from the Latin1 ANSI codepage. </summary> }
    function Latin1Lowercase:IWidecharSet;

    {! <summary>IWidecharSets.Latin1Uppercase returns an immutable set containing
      the Unicode equivalents of all upper case letters from the Latin1 ANSI codepage. </summary> }
    function Latin1Uppercase:IWidecharSet;

    {! <summary>IWidecharSets.Merge returns a new set that is the union of the
       two passed sets. </summary>
       <remarks>If either of the source sets is nil a copy of the other set
       will be returned. If both sets are nil an empty set is returned.
       The result set contains all characters from the source sets.
       </remarks> }
    function Merge(Set1, Set2: IWidecharset): IWidecharset;

    {! <summary>IWidecharSets.SciFloatChars returns an immutable set containing
    ...
    {! <summary>IWidecharSets.Subtract returns a new set that is the difference of the
       two passed sets. </summary>
       <remarks>If the first set is nil an empty set is returned. If the
         second set is nil a copy of the first set is returned.
       The result set contains all characters that are in Set1 but not in Set2.
       </remarks> }
    function Subtract(Set1, Set2: IWidecharset): IWidecharset;

    {! <summary>IWidecharSets.Whitespace returns a set containing
      the tab, space, carriage return, linefeed, and Unicode characters
      used like a space (e.g. the nonbreaking space). This set is not
      immutable since what an application considers whitespace may different
      from the default set here. Changes made to the returned set will be
      reflected by subsequent calls to Whitespace, since the returned
      set is a singleton. </summary> }
