...
type
  ...
  strict private
    ...
    procedure ListView_SizeChanged(sender: System.Object; e: System.EventArgs);
...
{$R 'OpenDialog\OpenDialog.TOpenDialog.resources' 'OpenDialog\OpenDialog.resx'}
...
begin
  ...
  Include(Self.ListView.SizeChanged, Self.ListView_SizeChanged);
...
procedure TOpenDialog.ListView_SizeChanged(sender: System.Object; e: System.EventArgs);
var
  S: Integer;
begin
  S := ListView.ClientSize.Width - ListView.Columns[0].Width;
  if S > ListView.Columns[1].Width then
    ListView.Columns[1].Width := S
  else if S > 4 then
    ListView.Columns[1].Width := S - 2;
end;
