...
begin
  BindingServices.AddKeyBinding( [Shortcut( Ord( 'D' ), [ssShift, ssCtrl] )],
    Dupline, nil );
  BindingServices.AddKeyBinding([Shortcut(Ord('C'), [ssShift, ssCtrl, ssAlt])],
    AppendComment, nil);
  BindingServices.AddKeyBinding([Shortcut(VK_F1, [ssCtrl, ssShift])],
    CommentToggle, nil);
